# SortDesk — The Fair First-Round Recruiter

> **AI Recruitment Assistant & Inbox Agent for Modern Talent Teams**
...
## 🌐 Running the SortDesk Website

SortDesk runs as a complete web application with a unified recruiter dashboard, draft approval queue, candidate talent pool, and AI assistant.

### 1. Launch the Server & Website
```bash
# Option A: Run website via python launcher
...
### 2. Open in Browser
- **Recruiter Web Dashboard**: [http://localhost:8000/](http://localhost:8000/) or [http://localhost:8000/dashboard](http://localhost:8000/dashboard)
- **FastAPI Interactive Docs (Swagger)**: [http://localhost:8000/docs](http://localhost:8000/docs)

### 3. Website Features
- **Unified Inbox**: Real-time message list across Outlook & Gmail, priority tags, and category labels.
- **Draft Approval Queue (Human-in-the-Loop)**: Review AI drafts side-by-side with applicant context, edit inline, and approve & dispatch replies.
- **Needs Attention (QUEUE-02)**: Flags high-priority messages that auto-resolve upon dispatch.
- **Candidate Talent Pool**: View parsed applicant profiles, roles applied for, and extracted technical skills.
- **Ingest / Test Sandbox**: Submit custom applicant emails and resumes to immediately run the AI pipeline.
- **RAG AI Assistant**: Interactive conversational search across your applicant pipeline and inboxes.

---

## Deploy to Vercel

SortDesk is pre-configured for 1-click deployment on [Vercel](https://vercel.com) using the included `vercel.json` and `api/index.py` serverless handler:

1. Push this repository to GitHub (or fork `https://github.com/MistiganKhan/sortdesk`).
2. Go to your [Vercel Dashboard](https://vercel.com/dashboard) and click **"Add New Project"**.
3. Select the **sortdesk** repository from your GitHub account.
4. Leave the default settings (Framework Preset: Other / Python detected automatically).
5. Click **Deploy**.
6. Your SortDesk website and API are live instantly with automatic SSL and global CDN!
...
# Run full Outlook integration trial simulation
npm test
```
